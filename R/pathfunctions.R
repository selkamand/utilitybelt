#' @title Get source directory (ONLY WORKS IF FILE IS SOURCED!)
#'
#' @description WARNING: if you run in interactive mode, this function will print an informative error
#'
...
#' @title Was this file sourced or run interactively?
#'
...
#' @title getpathProjectRootDirectory
#'
...
#' @title Finding Project Path, Check Directory Is Setup Correctly
#'
#' @description Before running \strong{getpathProjectRootDirectory()}, run \strong{checkScriptsDeclareTheirLocation(<project_dir>)} interactively.
